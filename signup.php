...
<input type="Email" id="Email" name="email" placeholder="Enter Your Email.."><br>
 <input type="password" name="password" id="Create password"  placeholder="create your password">
 <input type="password"  name="confirmpassword" id="confirm your password" placeholder="confirm your password..">
<button type="save" name="save" class="btn btn-primary">Sign Up</button>
